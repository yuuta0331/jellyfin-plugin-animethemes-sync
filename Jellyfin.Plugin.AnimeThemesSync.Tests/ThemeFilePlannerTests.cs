...
public class ThemeFilePlannerTests
{
    ...
    public void BrowserPagesExposeIntegratedSettingsAndSeasonFinder()
    {
        ...
        foreach (var file in browserPages)
        {
            ...
            Assert.Contains("id=\"AtsSettingsRunTask\"", content, StringComparison.Ordinal);
            Assert.Contains("Run Scheduled Task", content, StringComparison.Ordinal);
    ...
    public void BrowserPages_ShowLibraryGridViewModesSummaryAndDeleteActions()
    {
        ...
        foreach (var file in htmlFiles)
        {
            ...
            Assert.Contains("emby-textarea ats-transfer-textarea", content, StringComparison.Ordinal);
            Assert.Contains("ats-transfer-file", content, StringComparison.Ordinal);
            Assert.Contains("ats-visually-hidden", content, StringComparison.Ordinal);
            Assert.DoesNotContain("<h3>Settings Import / Export</h3>", content, StringComparison.Ordinal);
            Assert.DoesNotContain("<h3>Mappings Import / Export</h3>", content, StringComparison.Ordinal);
            ...
            Assert.Contains(">Library</span></h3>", content, StringComparison.Ordinal);
            Assert.Contains(">Matching</span></h3>", content, StringComparison.Ordinal);
            Assert.Contains(">Local Media</span></h3>", content, StringComparison.Ordinal);
            Assert.Contains(">System</span></h3>", content, StringComparison.Ordinal);
            Assert.Contains("ats-heading-with-icon", content, StringComparison.Ordinal);
            Assert.Contains("ats-icon-button-text", content, StringComparison.Ordinal);
            Assert.Contains("aria-hidden=\"true\"", content, StringComparison.Ordinal);
            ...
            Assert.Contains("AtsCleanupScan", content, StringComparison.Ordinal);
            Assert.Contains("AtsCleanupSource", content, StringComparison.Ordinal);
            Assert.Contains("Hide Browser downloads", content, StringComparison.Ordinal);
            Assert.Contains("Recommendation</label>", content, StringComparison.Ordinal);
            Assert.Contains("Added by</label>", content, StringComparison.Ordinal);
            Assert.Contains("[hidden] { display: none !important; }", content, StringComparison.Ordinal);
            Assert.DoesNotContain("Only Undesired files can be selected", content, StringComparison.Ordinal);
            Assert.Contains("Danger zone", content, StringComparison.Ordinal);
            Assert.DoesNotContain("id=\"AtsAllowDelete\"", content, StringComparison.Ordinal);
        ...
        Assert.Contains("AnimeThemesSync/Maintenance/Cleanup/Scans", jellyfinPage, StringComparison.Ordinal);
        ...
        Assert.Contains("AnimeThemesSync/Maintenance/Cleanup/Scans", embyController, StringComparison.Ordinal);

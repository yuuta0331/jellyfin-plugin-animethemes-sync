...
/// <summary>
/// Collection artwork compositor backed by the SkiaSharp 2.x assembly shipped with the Emby server.
/// </summary>
internal sealed class SkiaCollectionImageRenderer : ICollectionImageRenderer
{
        ...
        int canvasOpacityPercent)
    {
        ...
        try
        {
            ...
            using var drawPaint = new SKPaint { FilterQuality = SKFilterQuality.High };
            foreach (var cell in layout.Cells)
            {
                ...
                canvas.DrawBitmap(source, sourceRect, destRect, drawPaint);
            }
